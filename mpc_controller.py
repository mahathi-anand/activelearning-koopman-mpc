...
class ScenarioMPC:
    def __init__(self, task, config):
        ...
        self.use_info_gain = self.cfg.use_info_gain 
    ...
    def _build_problem(self):
        N=self.cfg.N
        S=self.cfg.S
        m_poly = self.cfg.H_x_full.shape[0]
        ...
        #Different scenarios for A and B, and info gradient
        ...
        # Input constraints and control cost
        for k in range(N):
            constraints += [
        ...
        # Dynamics, state constraints, and tracking cost for different scenarios
        for s in range(S):
            #Initial constraint
...
#Old program leaving it as is for now, to avoid breaking old code.
